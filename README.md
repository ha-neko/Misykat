...
- Download menghasilkan gambar quote ala Pinterest: pin di layar (wallpaper + quote + watermark) dicapture `react-native-view-shot` (snapshot view yang sudah ter-render — anti-race, anti-blank) → galeri via `createAssetAsync` → album "Misykat"
